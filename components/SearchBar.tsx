...
const SearchBar = ({setManufacturer, setModel}) => {
    ...
    const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
      e.preventDefault(); // to prevent it from refreshing as the default behaviour of the browser is to refresh on submitting a form
  ...
  return (
    <form className='searchbar' onSubmit={handleSearch}>
        ...
        <div className="searchbar__item">
          <Image src="/model-icon.png" alt="search item" width={25} height={25} className="absolute w-[20px] h-[20px] ml-4" />
